...
dete_pretrain_dir=${fluid_path}/PaddleCV/PaddleDetection/slim/distillation/pretrain
cd ${fluid_path}/PaddleSlim
...
# dete_pretrain
cd ${fluid_path}/PaddleCV/PaddleDection/slim/distillation
ln -s ${data_path}/PaddleSlim/dete_pretrain pretrain
